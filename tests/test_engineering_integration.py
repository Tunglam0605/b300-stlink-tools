    ...
    def test_shared_context_routes_and_guards_local_hardware(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            try:
                ...
                self.assertTrue(window.program_view.btn_flash_app.isEnabled())
                self.assertTrue(window.program_view.btn_dry_run_action.isEnabled())
                self.assertFalse(window.program_view.btn_flash_bootloader.isEnabled())
