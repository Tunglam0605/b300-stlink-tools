...
class GuiSmokeTests(unittest.TestCase):
    ...
    def tearDownClass(cls) -> None:
        ...
        # Keep a strong reference to the process-wide QApplication until process
        # termination. Releasing the final Python wrapper here can trigger a native
    ...
    def test_main_window_starts_safe_and_has_no_com_selector(self) -> None:
        ...
        self.assertTrue(window.status_banner.isVisible())
        self.assertEqual(window.page_title.text(), "Nạp firmware")
        ...
        self.app.processEvents()
        self.assertEqual(window.page_title.text(), "Remote Gateway / Client")
        self.assertIn("vai trò Gateway hoặc Client", window.status_banner.text())
